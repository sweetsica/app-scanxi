...
<main id="main">
    <div class="container">
      <div class="text-center my-2" id="arrow-down">
      ...
      <div class="container">
        <div class="list-img-product">
          <div class="title-product text-center mb-4">
            <h3>BỘ SẢN PHẨM DÀNH CHO XƯƠNG KHỚP</h3>
          </div>
          <div
            class="d-flex align-items-center justify-content-center position-relative list-product"
          >
            <img
